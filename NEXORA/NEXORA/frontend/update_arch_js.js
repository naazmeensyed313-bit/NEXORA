const fs = require('fs');
const file = 'C:/Users/naazm/OneDrive/Documents/Nexora project/NEXORA/NEXORA/frontend/architecture/architecture.js';

const newArchJS = `/* NEXORA — Architecture Builder JS
...
fs.writeFileSync(file, newArchJS);
console.log('Update architecture.js complete.');
